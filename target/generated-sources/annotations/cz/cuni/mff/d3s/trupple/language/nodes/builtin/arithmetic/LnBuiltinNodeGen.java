...
public final class LnBuiltinNodeGen extends LnBuiltinNode implements SpecializedNode {

    @Child private ExpressionNode argument_;
    @CompilationFinal private Class<?> argumentType_;
    @Child private BaseNode_ specialization_;

    private LnBuiltinNodeGen(ExpressionNode argument) {
    ...
    public static LnBuiltinNode create(ExpressionNode argument) {
        return new LnBuiltinNodeGen(argument);
    }
