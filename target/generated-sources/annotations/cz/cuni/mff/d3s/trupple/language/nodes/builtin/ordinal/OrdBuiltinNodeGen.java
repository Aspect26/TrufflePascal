...
public final class OrdBuiltinNodeGen extends OrdBuiltinNode implements SpecializedNode {

    @Child private ExpressionNode argument_;
    @CompilationFinal private Class<?> argumentType_;
    @Child private BaseNode_ specialization_;

    private OrdBuiltinNodeGen(ExpressionNode argument) {
    ...
    public static OrdBuiltinNode create(ExpressionNode argument) {
        return new OrdBuiltinNodeGen(argument);
    }
