...
public class Scanner {
	...
	static {
		...
		for (int i = 97; i <= 100; ++i) start.set(i, 1);
		for (int i = 102; i <= 116; ++i) start.set(i, 1);
		...
		literals.put("var", new Integer(6));
		literals.put("function", new Integer(12));
		literals.put("procedure", new Integer(15));
		literals.put("begin", new Integer(16));
		literals.put("end", new Integer(18));
		literals.put("case", new Integer(19));
		literals.put("of", new Integer(20));
		literals.put("while", new Integer(22));
		literals.put("do", new Integer(23));
		literals.put("repeat", new Integer(24));
		literals.put("until", new Integer(25));
		literals.put("for", new Integer(27));
		...
		literals.put("or", new Integer(33));
		literals.put("and", new Integer(34));
		literals.put("div", new Integer(44));
		literals.put("mod", new Integer(45));
	...
	Token NextToken() {
		...
		loop: for (;;) {
			switch (state) {
				...
				case 2:
					if (ch <= 9 || ch >= 11 && ch <= 12 || ch >= 14 && ch <= '!' || ch >= '#' && ch <= '&' || ch >= '(' && ch <= '[' || ch >= ']' && ch <= 65535) {AddCh(); state = 2; break;}
					else if (ch == 39) {AddCh(); state = 6; break;}
					else {state = 0; break;}
				case 3:
				...
				case 4:
					{t.kind = 3; break loop;}
				case 5:
					if (ch <= 9 || ch >= 11 && ch <= 12 || ch >= 14 && ch <= '!' || ch >= '#' && ch <= '&' || ch >= '(' && ch <= '[' || ch >= ']' && ch <= 65535) {AddCh(); state = 7; break;}
					else if (ch == 39) {AddCh(); state = 8; break;}
					else {state = 0; break;}
				case 6:
				...
				case 18:
					if (ch == 'p') {AddCh(); state = 19; break;}
					else {state = 0; break;}
				case 19:
					if (ch == 'e') {AddCh(); state = 20; break;}
					else {state = 0; break;}
				case 20:
					if (ch == 's') {AddCh(); state = 21; break;}
					else {state = 0; break;}
				case 21:
				...
				case 40:
					...
					else if (ch == 'n') {AddCh(); state = 45; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 41:
				...
				case 42:
					recEnd = pos; recKind = 1;
					if (ch >= '0' && ch <= '9' || ch >= 'a' && ch <= 'm' || ch >= 'o' && ch <= 'z') {AddCh(); state = 1; break;}
					else if (ch == 'n') {AddCh(); state = 46; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 43:
				...
				case 45:
					recEnd = pos; recKind = 1;
					if (ch >= '0' && ch <= '9' || ch >= 'a' && ch <= 'e' || ch >= 'g' && ch <= 'z') {AddCh(); state = 1; break;}
				...
				case 47:
					recEnd = pos; recKind = 1;
					if (ch >= '0' && ch <= '9' || ch >= 'a' && ch <= 'h' || ch >= 'j' && ch <= 'z') {AddCh(); state = 1; break;}
					else if (ch == 'i') {AddCh(); state = 49; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 48:
					recEnd = pos; recKind = 1;
					if (ch >= '0' && ch <= '9' || ch >= 'a' && ch <= 'z') {AddCh(); state = 1; break;}
				...
				case 50:
					recEnd = pos; recKind = 1;
					if (ch >= '0' && ch <= '9' || ch >= 'a' && ch <= 'h' || ch >= 'j' && ch <= 'z') {AddCh(); state = 1; break;}
					else if (ch == 'i') {AddCh(); state = 51; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 51:
					recEnd = pos; recKind = 1;
					if (ch >= '0' && ch <= '9' || ch >= 'a' && ch <= 'r' || ch >= 't' && ch <= 'z') {AddCh(); state = 1; break;}
					else if (ch == 's') {AddCh(); state = 52; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 52:
					recEnd = pos; recKind = 1;
					if (ch >= '0' && ch <= '9' || ch >= 'a' && ch <= 'g' || ch >= 'i' && ch <= 'z') {AddCh(); state = 1; break;}
					else if (ch == 'h') {AddCh(); state = 53; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 53:
					recEnd = pos; recKind = 1;
					if (ch >= '0' && ch <= '9' || ch >= 'a' && ch <= 'd' || ch >= 'f' && ch <= 'z') {AddCh(); state = 1; break;}
					else if (ch == 'e') {AddCh(); state = 54; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 54:
					recEnd = pos; recKind = 1;
					if (ch >= '0' && ch <= '9' || ch >= 'a' && ch <= 'c' || ch >= 'e' && ch <= 'z') {AddCh(); state = 1; break;}
					else if (ch == 'd') {AddCh(); state = 55; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 55:
					recEnd = pos; recKind = 1;
					if (ch >= '0' && ch <= '9' || ch >= 'a' && ch <= 'z') {AddCh(); state = 1; break;}
					else if (ch == '_') {AddCh(); state = 56; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 56:
					if (ch == 'u') {AddCh(); state = 10; break;}
					else if (ch == 'a') {AddCh(); state = 16; break;}
					else if (ch == 't') {AddCh(); state = 17; break;}
					else if (ch == 'c') {AddCh(); state = 25; break;}
					else if (ch == 'f') {AddCh(); state = 29; break;}
					else {state = 0; break;}
