...
import cz.cuni.mff.d3s.pascal.language.nodes.BlockNode;
import cz.cuni.mff.d3s.pascal.language.nodes.ExpressionNode;
import cz.cuni.mff.d3s.pascal.language.nodes.NopNode;
import cz.cuni.mff.d3s.pascal.language.nodes.PascalRootNode;
import cz.cuni.mff.d3s.pascal.language.nodes.StatementNode;
import cz.cuni.mff.d3s.pascal.language.nodes.arithmetic.AddNodeGen;
import cz.cuni.mff.d3s.pascal.language.nodes.arithmetic.DivideIntegerNodeGen;
import cz.cuni.mff.d3s.pascal.language.nodes.arithmetic.ModuloNodeGen;
import cz.cuni.mff.d3s.pascal.language.nodes.arithmetic.MultiplyNodeGen;
import cz.cuni.mff.d3s.pascal.language.nodes.arithmetic.NegationNodeGen;
import cz.cuni.mff.d3s.pascal.language.nodes.arithmetic.SubstractNodeGen;
import cz.cuni.mff.d3s.pascal.language.nodes.call.InvokeNodeGen;
import cz.cuni.mff.d3s.pascal.language.nodes.control.BreakNode;
import cz.cuni.mff.d3s.pascal.language.nodes.control.CaseNode;
import cz.cuni.mff.d3s.pascal.language.nodes.control.ForNode;
import cz.cuni.mff.d3s.pascal.language.nodes.control.IfNode;
import cz.cuni.mff.d3s.pascal.language.nodes.control.RepeatNode;
import cz.cuni.mff.d3s.pascal.language.nodes.control.WhileNode;
import cz.cuni.mff.d3s.pascal.language.nodes.function.FunctionBodyNode;
import cz.cuni.mff.d3s.pascal.language.nodes.function.FunctionBodyNodeGen;
import cz.cuni.mff.d3s.pascal.language.nodes.function.ProcedureBodyNode;
import cz.cuni.mff.d3s.pascal.language.nodes.function.ReadSubroutineArgumentNodeGen;
import cz.cuni.mff.d3s.pascal.language.nodes.literals.CharLiteralNode;
import cz.cuni.mff.d3s.pascal.language.nodes.literals.DoubleLiteralNode;
import cz.cuni.mff.d3s.pascal.language.nodes.literals.FunctionLiteralNode;
import cz.cuni.mff.d3s.pascal.language.nodes.literals.LogicLiteralNode;
import cz.cuni.mff.d3s.pascal.language.nodes.literals.LongLiteralNode;
import cz.cuni.mff.d3s.pascal.language.nodes.literals.StringLiteralNode;
import cz.cuni.mff.d3s.pascal.language.nodes.logic.AndNodeGen;
import cz.cuni.mff.d3s.pascal.language.nodes.logic.EqualsNodeGen;
import cz.cuni.mff.d3s.pascal.language.nodes.logic.LessThanNodeGen;
import cz.cuni.mff.d3s.pascal.language.nodes.logic.LessThanOrEqualNodeGen;
import cz.cuni.mff.d3s.pascal.language.nodes.logic.NotNodeGen;
import cz.cuni.mff.d3s.pascal.language.nodes.logic.OrNodeGen;
...
import cz.cuni.mff.d3s.pascal.language.nodes.variables.ReadVariableNodeGen;
