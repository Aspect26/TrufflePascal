...
public final class AndNodeGen extends AndNode {

    @Child private ExpressionNode leftNode_;
    @Child private ExpressionNode rightNode_;
    @CompilationFinal private boolean seenUnsupported0;

    private AndNodeGen(ExpressionNode leftNode, ExpressionNode rightNode) {
    ...
    public static AndNode create(ExpressionNode leftNode, ExpressionNode rightNode) {
        return new AndNodeGen(leftNode, rightNode);
    }
