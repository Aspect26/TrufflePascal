...
public final class DivideIntegerNodeGen extends DivideIntegerNode implements SpecializedNode {
    ...
    @CompilationFinal private boolean excludeDiv0_;
    @CompilationFinal private boolean excludeDiv1_;
    @CompilationFinal private boolean excludeDiv2_;
    @CompilationFinal private boolean excludeDiv3_;
    ...
    private abstract static class BaseNode_ extends SpecializationNode {
        ...
        @CompilationFinal protected DivideIntegerNodeGen root;

        BaseNode_(DivideIntegerNodeGen root, int index) {
            super(index);
            this.root = root;
        }
        ...
        protected final void setRoot(Node root) {
            this.root = (DivideIntegerNodeGen) root;
        }
        ...
        protected final SpecializationNode createNext(Frame frameValue, Object leftNodeValue, Object rightNodeValue) {
            ...
            if (rightNodeValue instanceof Double) {
                if (leftNodeValue instanceof Long) {
                    if (!root.excludeDiv2_) {
                        return Div2Node_.create(root);
                    }
                }
                if (leftNodeValue instanceof Double) {
                    if (!root.excludeDiv3_) {
    ...
    private static final class UninitializedNode_ extends BaseNode_ {
        ...
        UninitializedNode_(DivideIntegerNodeGen root) {
        ...
        static BaseNode_ create(DivideIntegerNodeGen root) {
    ...
    private static final class PolymorphicNode_ extends BaseNode_ {
        ...
        PolymorphicNode_(DivideIntegerNodeGen root) {
            super(root, 0);
        }
    ...
    @GeneratedBy(methodName = "div(long, long)", value = DivideIntegerNode.class)
    private static final class Div0Node_ extends BaseNode_ {

        Div0Node_(DivideIntegerNodeGen root) {
            super(root, 1);
        }
    ...
    @GeneratedBy(methodName = "div(double, long)", value = DivideIntegerNode.class)
    private static final class Div1Node_ extends BaseNode_ {

        Div1Node_(DivideIntegerNodeGen root) {
            super(root, 2);
        }
    ...
    @GeneratedBy(methodName = "div(long, double)", value = DivideIntegerNode.class)
    private static final class Div2Node_ extends BaseNode_ {

        Div2Node_(DivideIntegerNodeGen root) {
            super(root, 3);
        }
    ...
    @GeneratedBy(methodName = "div(double, double)", value = DivideIntegerNode.class)
    private static final class Div3Node_ extends BaseNode_ {

        Div3Node_(DivideIntegerNodeGen root) {
            super(root, 4);
        }
