...
{
    Draws a 3d bar with topleft corner at (x1, y1) and bottom right corner at (x2, y2). Depth specifies the number of
    pixels used to show the depth of the bar. If Top is true; then a 3-dimensional top is drawn.
}
