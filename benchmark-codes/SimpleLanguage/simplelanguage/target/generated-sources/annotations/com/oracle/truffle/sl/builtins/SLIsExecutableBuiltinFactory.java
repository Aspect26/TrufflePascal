...
public final class SLIsExecutableBuiltinFactory implements NodeFactory<SLIsExecutableBuiltin> {

    private static SLIsExecutableBuiltinFactory instance;
    ...
    public static NodeFactory<SLIsExecutableBuiltin> getInstance() {
        if (instance == null) {
            instance = new SLIsExecutableBuiltinFactory();
        }
        return instance;
    }

    public static SLIsExecutableBuiltin create(SLExpressionNode[] arguments, SLContext context) {
        return new SLIsExecutableBuiltinNodeGen(arguments, context);
    }
    ...
    public static final class SLIsExecutableBuiltinNodeGen extends SLIsExecutableBuiltin {
        ...
        private SLIsExecutableBuiltinNodeGen(SLExpressionNode[] arguments, SLContext context) {
        ...
        public Object executeGeneric(VirtualFrame frameValue) {
            ...
            if ((state & 0b10) != 0 /* is-active isExecutable(VirtualFrame, TruffleObject) */ && arguments0Value_ instanceof TruffleObject) {
                TruffleObject arguments0Value__ = (TruffleObject) arguments0Value_;
                return isExecutable(frameValue, arguments0Value__);
            }
        ...
        private Object executeAndSpecialize(VirtualFrame frameValue, Object arguments0Value) {
            ...
            try {
                ...
                if (arguments0Value instanceof TruffleObject) {
                    ...
                    this.state_ = state | 0b10 /* add-active isExecutable(VirtualFrame, TruffleObject) */;
                    lock.unlock();
                    hasLock = false;
                    return isExecutable(frameValue, arguments0Value_);
                }
                CompilerDirectives.transferToInterpreterAndInvalidate();
