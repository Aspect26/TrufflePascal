...
public final class SLGetSizeBuiltinFactory implements NodeFactory<SLGetSizeBuiltin> {
    ...
    private static SLGetSizeBuiltinFactory instance;
    ...
    public static NodeFactory<SLGetSizeBuiltin> getInstance() {
        if (instance == null) {
            instance = new SLGetSizeBuiltinFactory();
        }
        return instance;
    }

    public static SLGetSizeBuiltin create(SLExpressionNode[] arguments, SLContext context) {
        return new SLGetSizeBuiltinNodeGen(arguments, context);
    }
    ...
    public static final class SLGetSizeBuiltinNodeGen extends SLGetSizeBuiltin {
        ...
        private SLGetSizeBuiltinNodeGen(SLExpressionNode[] arguments, SLContext context) {
        ...
        public Object executeGeneric(VirtualFrame frameValue) {
            ...
            if ((state & 0b10) != 0 /* is-active getSize(VirtualFrame, TruffleObject) */ && arguments0Value_ instanceof TruffleObject) {
                TruffleObject arguments0Value__ = (TruffleObject) arguments0Value_;
                return getSize(frameValue, arguments0Value__);
            }
        ...
        private Object executeAndSpecialize(VirtualFrame frameValue, Object arguments0Value) {
            ...
            try {
                ...
                if (arguments0Value instanceof TruffleObject) {
                    ...
                    this.state_ = state | 0b10 /* add-active getSize(VirtualFrame, TruffleObject) */;
                    lock.unlock();
                    hasLock = false;
                    return getSize(frameValue, arguments0Value_);
                }
                CompilerDirectives.transferToInterpreterAndInvalidate();
