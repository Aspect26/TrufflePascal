...
public final class SLNewObjectBuiltinFactory implements NodeFactory<SLNewObjectBuiltin> {
    ...
    public static SLNewObjectBuiltin create(SLExpressionNode[] arguments, SLContext context) {
        return new SLNewObjectBuiltinNodeGen(arguments, context);
    }
    ...
    public static final class SLNewObjectBuiltinNodeGen extends SLNewObjectBuiltin {
        ...
        private SLNewObjectBuiltinNodeGen(SLExpressionNode[] arguments, SLContext context) {
        ...
        public Object executeGeneric(VirtualFrame frameValue) {
            int state = state_;
            if ((state & 0b10) != 0 /* is-active newObject() */) {
                return newObject();
            }
        ...
        private Object executeAndSpecialize() {
            ...
            try {
                ...
                this.state_ = state | 0b10 /* add-active newObject() */;
                lock.unlock();
                hasLock = false;
                return newObject();
            } finally {
