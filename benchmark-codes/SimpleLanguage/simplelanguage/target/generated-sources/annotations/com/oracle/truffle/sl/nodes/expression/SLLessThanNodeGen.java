...
public final class SLLessThanNodeGen extends SLLessThanNode {
    ...
    public boolean executeBoolean(VirtualFrame frameValue) {
        int state = state_;
        if ((state & 0b101) == 0 /* only-active lessThan(long, long) */) {
    ...
    private boolean executeBoolean_generic1(VirtualFrame frameValue, int state) {
        ...
        if ((state & 0b100) != 0 /* is-active lessThan(BigInteger, BigInteger) */ && SLTypesGen.isImplicitBigInteger((state & 0b11000) >>> 3 /* extract-implicit-active 0:BigInteger */, leftNodeValue_)) {
