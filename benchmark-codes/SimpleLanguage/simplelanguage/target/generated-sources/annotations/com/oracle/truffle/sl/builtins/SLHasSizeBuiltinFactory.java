...
public final class SLHasSizeBuiltinFactory implements NodeFactory<SLHasSizeBuiltin> {
    ...
    private static SLHasSizeBuiltinFactory instance;
    ...
    public static NodeFactory<SLHasSizeBuiltin> getInstance() {
        if (instance == null) {
            instance = new SLHasSizeBuiltinFactory();
        }
        return instance;
    }

    public static SLHasSizeBuiltin create(SLExpressionNode[] arguments, SLContext context) {
        return new SLHasSizeBuiltinNodeGen(arguments, context);
    }
    ...
    public static final class SLHasSizeBuiltinNodeGen extends SLHasSizeBuiltin {
        ...
        private SLHasSizeBuiltinNodeGen(SLExpressionNode[] arguments, SLContext context) {
        ...
        public Object executeGeneric(VirtualFrame frameValue) {
            ...
            if ((state & 0b10) != 0 /* is-active hasSize(VirtualFrame, TruffleObject) */ && arguments0Value_ instanceof TruffleObject) {
                TruffleObject arguments0Value__ = (TruffleObject) arguments0Value_;
                return hasSize(frameValue, arguments0Value__);
            }
        ...
        private Object executeAndSpecialize(VirtualFrame frameValue, Object arguments0Value) {
            ...
            try {
                ...
                if (arguments0Value instanceof TruffleObject) {
                    ...
                    this.state_ = state | 0b10 /* add-active hasSize(VirtualFrame, TruffleObject) */;
                    lock.unlock();
                    hasLock = false;
                    return hasSize(frameValue, arguments0Value_);
                }
                CompilerDirectives.transferToInterpreterAndInvalidate();
