...
public final class SLDivNodeGen extends SLDivNode {
    ...
    public Object executeGeneric(VirtualFrame frameValue) {
        int state = state_;
        if ((state & 0b101) == 0 /* only-active div(long, long) */) {
    ...
    private Object executeGeneric_long_long0(VirtualFrame frameValue, int state) {
        ...
        assert (state & 0b10) != 0 /* is-active div(long, long) */;
        try {
            ...
            try {
                ...
                this.state_ = this.state_ & 0xfffffffd /* remove-active div(long, long) */;
            } finally {
                lock.unlock();
            }
    ...
    private Object executeGeneric_generic1(VirtualFrame frameValue, int state) {
        ...
        if ((state & 0b10) != 0 /* is-active div(long, long) */ && leftNodeValue_ instanceof Long) {
        ...
        if ((state & 0b100) != 0 /* is-active div(BigInteger, BigInteger) */ && SLTypesGen.isImplicitBigInteger((state & 0b11000) >>> 3 /* extract-implicit-active 0:BigInteger */, leftNodeValue_)) {
    ...
    public long executeLong(VirtualFrame frameValue) throws UnexpectedResultException {
        ...
        if ((state & 0b10) != 0 /* is-active div(long, long) */) {
            try {
                return div(leftNodeValue_, rightNodeValue_);
            } catch (ArithmeticException ex) {
                // implicit transferToInterpreterAndInvalidate()
    ...
    private Object executeAndSpecialize(Object leftNodeValue, Object rightNodeValue) {
        ...
        try {
            ...
            if ((exclude & 0b1) == 0 /* is-not-excluded div(long, long) */ && leftNodeValue instanceof Long) {
                long leftNodeValue_ = (long) leftNodeValue;
                if (rightNodeValue instanceof Long) {
                    long rightNodeValue_ = (long) rightNodeValue;
                    this.state_ = state | 0b10 /* add-active div(long, long) */;
                    try {
                        lock.unlock();
                        hasLock = false;
                        return div(leftNodeValue_, rightNodeValue_);
            ...
            }
            {
                ...
                if ((bigIntegerCast0 = SLTypesGen.specializeImplicitBigInteger(leftNodeValue)) != 0) {
                    ...
                    if ((bigIntegerCast1 = SLTypesGen.specializeImplicitBigInteger(rightNodeValue)) != 0) {
                        ...
                        this.state_ = state | 0b100 /* add-active div(BigInteger, BigInteger) */;
                        lock.unlock();
                        hasLock = false;
                        return div(leftNodeValue_, rightNodeValue_);
                    }
