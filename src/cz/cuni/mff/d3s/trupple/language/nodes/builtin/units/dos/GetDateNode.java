...
public abstract class GetDateNode extends ExpressionNode {

    @Specialization
    int getDate(Reference yearReference, Reference monthReference, Reference dayReference, Reference weekDayReference) {
