...
/**
 * Node representing Pascal's write subroutine. It receives its arguments in an array because it may receive any number
 * of arguments. The arguments are received by {@link cz.cuni.mff.d3s.trupple.language.nodes.call.ReadAllArgumentsNode}
 * node.
 *
 * This node uses specializations which means that it is not used directly but completed node is generated by Truffle.
 * {@link WriteBuiltinNodeFactory.WriteBuiltinNodeGen}
 */
