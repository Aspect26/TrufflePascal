...
public final class AddNodeGen extends AddNode implements SpecializedNode {
    ...
    public static AddNode create(ExpressionNode leftNode, ExpressionNode rightNode) {
        return new AddNodeGen(leftNode, rightNode);
    }
    ...
    @GeneratedBy(methodName = "add(long, long)", value = AddNode.class)
