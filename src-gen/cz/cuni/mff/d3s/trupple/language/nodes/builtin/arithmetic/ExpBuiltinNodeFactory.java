...
public final class ExpBuiltinNodeFactory implements NodeFactory<ExpBuiltinNode> {
    ...
    public static ExpBuiltinNode create(PascalContext context, ExpressionNode argument) {
        return new ExpBuiltinNodeGen(context, argument);
    }
    ...
    public static final class ExpBuiltinNodeGen extends ExpBuiltinNode implements SpecializedNode {
        ...
        private ExpBuiltinNodeGen(PascalContext context, ExpressionNode argument) {
            super(context);
