...
public final class ChrBuiltinNodeFactory implements NodeFactory<ChrBuiltinNode> {
    ...
    public static ChrBuiltinNode create(PascalContext context, ExpressionNode argument) {
        return new ChrBuiltinNodeGen(context, argument);
    }
    ...
    public static final class ChrBuiltinNodeGen extends ChrBuiltinNode {
        ...
        private ChrBuiltinNodeGen(PascalContext context, ExpressionNode argument) {
            super(context);
