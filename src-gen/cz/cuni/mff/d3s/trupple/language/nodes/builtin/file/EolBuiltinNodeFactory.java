...
public final class EolBuiltinNodeFactory implements NodeFactory<EolBuiltinNode> {
    ...
    public static EolBuiltinNode create(PascalContext context, ExpressionNode[] arguments) {
        return new EolBuiltinNodeGen(context, arguments);
    }
    ...
    public static final class EolBuiltinNodeGen extends EolBuiltinNode {
        ...
        private EolBuiltinNodeGen(PascalContext context, ExpressionNode[] arguments) {
            super(context);
