...
public final class CosBuiltinNodeFactory implements NodeFactory<CosBuiltinNode> {

    private static CosBuiltinNodeFactory instance;

    private CosBuiltinNodeFactory() {
    }

    @Override
    public Class<CosBuiltinNode> getNodeClass() {
        return CosBuiltinNode.class;
    }
    ...
    @Override
    public CosBuiltinNode createNode(Object... arguments) {
    ...
    public static NodeFactory<CosBuiltinNode> getInstance() {
        if (instance == null) {
            instance = new CosBuiltinNodeFactory();
        }
        return instance;
    }

    public static CosBuiltinNode create(PascalContext context, ExpressionNode argument) {
        return new CosBuiltinNodeGen(context, argument);
    }

    @GeneratedBy(CosBuiltinNode.class)
    public static final class CosBuiltinNodeGen extends CosBuiltinNode implements SpecializedNode {

        @Child private ExpressionNode argument_;
        @CompilationFinal private Class<?> argumentType_;
        @Child private BaseNode_ specialization_;

        private CosBuiltinNodeGen(PascalContext context, ExpressionNode argument) {
            super(context);
