...
public final class OddBuiltinFunctionFactory implements NodeFactory<OddBuiltinNode> {

    private static OddBuiltinFunctionFactory instance;

    private OddBuiltinFunctionFactory() {
    }
    ...
    public static NodeFactory<OddBuiltinNode> getInstance() {
        if (instance == null) {
            instance = new OddBuiltinFunctionFactory();
        }
        return instance;
    }

    public static OddBuiltinNode create(PascalContext context, ExpressionNode argument) {
        return new OddBuiltinFunctionNodeGen(context, argument);
    }

    @GeneratedBy(OddBuiltinNode.class)
    public static final class OddBuiltinFunctionNodeGen extends OddBuiltinNode {

        @Child private ExpressionNode argument_;
        @CompilationFinal private boolean seenUnsupported0;

        private OddBuiltinFunctionNodeGen(PascalContext context, ExpressionNode argument) {
            super(context);
