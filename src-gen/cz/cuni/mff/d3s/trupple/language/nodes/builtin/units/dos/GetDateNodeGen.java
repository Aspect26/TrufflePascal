...
@GeneratedBy(GetDateNode.class)
public final class GetDateNodeGen extends GetDateNode {
    ...
    private GetDateNodeGen(ExpressionNode child0, ExpressionNode child1, ExpressionNode child2, ExpressionNode child3) {
        this.child0_ = child0;
        this.child1_ = child1;
        this.child2_ = child2;
        this.child3_ = child3;
    ...
    public void executeVoid(VirtualFrame frameValue) {
        ...
        this.getDate(child0Value_, child1Value_, child2Value_, child3Value_);
        return;
    }
    ...
    public static GetDateNode create(ExpressionNode child0, ExpressionNode child1, ExpressionNode child2, ExpressionNode child3) {
        return new GetDateNodeGen(child0, child1, child2, child3);
    }
