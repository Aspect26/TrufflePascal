...
public final class MultiplyNodeGen extends MultiplyNode implements SpecializedNode {
    ...
    public static MultiplyNode create(ExpressionNode leftNode, ExpressionNode rightNode) {
        return new MultiplyNodeGen(leftNode, rightNode);
    }

    @GeneratedBy(MultiplyNode.class)
    private abstract static class BaseNode_ extends SpecializationNode {

        @CompilationFinal protected MultiplyNodeGen root;

        BaseNode_(MultiplyNodeGen root, int index) {
            super(index);
            this.root = root;
        }
        ...
        protected final void setRoot(Node root) {
            this.root = (MultiplyNodeGen) root;
        }
    ...
    private static final class UninitializedNode_ extends BaseNode_ {
        ...
        UninitializedNode_(MultiplyNodeGen root) {
    ...
    private static final class PolymorphicNode_ extends BaseNode_ {
        ...
        PolymorphicNode_(MultiplyNodeGen root) {
            super(root, 0);
        }
    ...
    @GeneratedBy(methodName = "mul(long, long)", value = MultiplyNode.class)
    private static final class Mul0Node_ extends BaseNode_ {

        Mul0Node_(MultiplyNodeGen root) {
            super(root, 1);
        }
